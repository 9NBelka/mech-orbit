        ...
        <div className={styles.contactsAndFormBlock}>
          <div className={styles.textContent}>
            <h3 className={styles.titleScreen}>
              Want a controlled and <span>profitable</span> auto service?
            </h3>
            <p className={styles.textDescription}>
              Leave your contact details and we will propose an implementation format tailored to
              your service: taking into account the current team size and goals.
            </p>
            <div className={styles.contactInfo}>
              <div className={styles.contactItem}>
                <div className={styles.iconAndContacts}>
                  ...
                  <div>
                    <p className={styles.contactItemTitleMini}>Write to us</p>
                    <a
              ...
              <div className={styles.contactItem}>
                <div className={styles.iconAndContacts}>
                  ...
                  <div>
                    <p className={styles.contactItemTitleMini}>Call us</p>
