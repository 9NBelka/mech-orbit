  ...
  const faqs = [
    {
      ...
      answer:
        'Так, ми надаємо 14 днів безкоштовного тестування програмного забезпечення. Це ключова частина нашого `Тестового шляху`, де ви можете на власному обладнанні або з нашою TestCam оцінити всі переваги системи, перш ніж приймати рішення про купівлю.',
    },
    {
