  ...
  const integrationsInfo = [
    ...
    },
    {
      ...
      list: [
        ...
        {
          pointTitle: 'Таймер нормогодин',
          pointDescription: 'Фактична вартість нормогодини',
          pointStatus: 'LIVE',
        },
      ],
    },
      ...
      list: [
        {
          ...
          pointDescription: 'Єдиний державний рєєстр трансопртних засобів.',
          pointStatus: 'LIVE',
        },
        {
          pointTitle: 'IP телефонія',
          pointDescription: 'Запис розмов привязана до клієнта',
          pointStatus: 'BETA',
          pointStatusClass: 'classBlueStatus',
        },
        {
          pointTitle: 'Чат з клієнтом',
        ...
        },
        {
          ...
          pointDescription: 'Користуватись ПРРО',
          pointStatus: 'BETA',
          pointStatusClass: 'classBlueStatus',
        },
      ],
