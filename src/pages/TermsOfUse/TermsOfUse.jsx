...
const translations = {
  ua: {
    ...
    section5_desc:
      'Ми залишаємо за собою право змінювати ці Умови використання в будь-який час. Продовження використання веб-сайту означає прийняття оновлених умов.',
  ...
  ru: {
    ...
    titleHighlight: 'MechOrbit',
    description1:
      'Добро пожаловать на веб-сайт MechOrbit. Используя наш веб-сайт, вы соглашаетесь соблюдать данные Условия использования. Если вы не согласны с любой частью этих условий, пожалуйста, не используйте сайт.',
    ...
    section3_desc:
      'Весь контент на веб-сайте является собственностью MechOrbit или используется на законных основаниях и защищён авторским правом.',
  ...
  en: {
    ...
    section3_desc:
      'All content on the Website is the property of MechOrbit or used lawfully and is protected by copyright laws.',
