...
const translations = {
  ua: {
    ...
    section5_desc:
      'Договір набирає чинності з моменту акцепту оферти користувачем.',
  ...
  ru: {
    ...
    section5_desc:
      'Договор вступает в силу с момента акцепта оферты пользователем.',
    contact: 'Email: hello@mechorbit.com',
  },
  ...
  en: {
    ...
    section4_desc:
      'The parties shall be liable in accordance with applicable law.',
    section5: '5. Final Provisions',
    section5_desc:
      'The Agreement enters into force upon acceptance of the offer by the User.',
    contact: 'Email: hello@mechorbit.com',
  },
};
